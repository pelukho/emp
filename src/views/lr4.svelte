...
<blockquote class="blockquote">
    ...
    <ol>
        <li>Н0 – Різниця ЗП програміста за рахунок впливу фактора освіти не істотна, випадкова <br>
            Н1 – Різниця ЗП програміста за рахунок впливу фактора освіти не є випадкова
        </li>
        <li>Н0 – Різниця ЗП програміста за рахунок впливу фактора статі не істотна, випадкова <br>
            Н1 – Різниця ЗП програміста за рахунок впливу фактора статі не є випадкова
        </li>
        <li>Н0 – Різниця ЗП програміста за рахунок впливу фактора освіти однакова для
            різних градацій фактора статі та навпаки <br>
            Н1 – Різниця ЗП програміста за рахунок впливу фактора освіти не є однаковою для
            різних градацій фактора статі та навпаки.
        </li>
    </ol>
</blockquote>
